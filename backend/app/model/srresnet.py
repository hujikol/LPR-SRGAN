...
def build_srresnet(scale=4, num_filters=64, num_res_blocks=16, num_upsamples=2):

    lr = Input(shape=(None, None, 3))
    x = Lambda(preprocess.normalize_img01)(lr)
    ...
    sr = Lambda(preprocess.denormalize_img11)(x)
